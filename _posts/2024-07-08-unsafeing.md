...
Now that this is out of the way: this week's post is about figuring out why we're so slow (spoilers: I don't, not really) and being evil by using `unsafe` (spoilers: I do that, it's pretty easy).
